...
| https://www.zenml.io/llmops-database/evolving-ai-coding-agent-workflows-from-research-plan-implement-to-crispy | 2026-05-17 | `agent-development-lifecycle.md` | Medium — article/database entry |
| https://www.humanlayer.dev/blog/advanced-context-engineering | 2026-05-17 | `agent-development-lifecycle.md` | Medium — blog post |
| https://aipatternbook.com/research-plan-implement | 2026-05-17 | `agent-development-lifecycle.md` | Low — pattern article |
| https://www.ics.uci.edu/~redmiles/publications/C030-VRR99.pdf | 2026-05-17 | `html-prototyping-for-agent-review.md` | Static — research paper |
| https://decode.dev/ | 2026-05-17 | `html-prototyping-for-agent-review.md` | Medium — product site |
| https://relayer.app/ | 2026-05-17 | `html-prototyping-for-agent-review.md` | Medium — product site |
| https://github.com/pgvector/pgvector | 2026-05-17 | `composable-data-storage.md` | Medium — active project |
| https://age.apache.org/ | 2026-05-17 | `composable-data-storage.md` | Medium — active project |
| https://www.postgresql.org/docs/current/textsearch.html | 2026-05-17 | `composable-data-storage.md` | Medium — current PostgreSQL docs |
| https://obsidian.md/help/sync-notes | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Low — official docs |
| https://obsidian.md/help/sync/headless | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Low — official docs |
| https://docs.github.com/en/rest/repos/contents | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Medium — API docs |
| https://docs.aws.amazon.com/AmazonS3/latest/userguide/versioning-workflows.html | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Low — official docs |
| https://outstatic.com/ | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Medium — product site |
| https://gitcms.dev/docs/ | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Medium — product docs |
| https://dhub.dev/ | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Medium — product site |
| https://cmsconf.com/knowledge/tinacms/ | 2026-05-17 | `markdown-knowledge-webapp-architecture.md` | Medium — article |
| https://docs.pinecone.io/guides/search/full-text-search | 2026-05-17 | `pinecone-retrieval.md`, `composable-data-storage.md` | High — preview-era product docs |
| https://docs.pinecone.io/guides/operations/local-development | 2026-05-17 | `pinecone-retrieval.md` | High — product docs |
| https://docs.pinecone.io/guides/index-data/dedicated-read-nodes | 2026-05-17 | `pinecone-retrieval.md` | High — product docs |
| https://www.pinecone.io/blog/full-text-search/ | 2026-05-17 | `pinecone-retrieval.md` | Medium — product announcement |
| https://www.pinecone.io/blog/knowledge-infrastructure-for-agents/ | 2026-05-17 | `pinecone-retrieval.md` | Medium — product announcement |
| https://www.pinecone.io/blog/builder-plan/ | 2026-05-17 | `pinecone-retrieval.md` | Medium — product announcement |
| https://www.pinecone.io/blog/byoc/ | 2026-05-17 | `pinecone-retrieval.md` | Medium — product announcement |
